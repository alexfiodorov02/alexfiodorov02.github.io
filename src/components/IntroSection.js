const IntroSection = () => {
  const introText = [
    "Hi there!",
    "My name is Alex. I build full-stack tools and think a lot about how design meets engineering. I started developing software when I was four (yes, really), and that early obsession never left. At 17, I co-founded a CS education startup that reached 2M+ students and taught me a lot about inclusive tech, fast-paced teamwork, and how to ship things that actually matter.",
